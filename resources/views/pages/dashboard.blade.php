                ...
                <div class="card">
                    <div class="card-body p-3">
                        <div class="row">
                            <div class="col-8">
                                <div class="numbers">
                                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Total Issues</p>
                                    <h5 class="font-weight-bolder">
                                        {{ $reports }}
                                    </h5>
                                </div>
                                ...
                                <li
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="d-flex flex-column">
                                            <h6 class="mb-1 text-dark text-sm">{{ $category->value }}</h6>
                                            <span
                                                class="text-xs">{{ App\Models\Post::where('ref_category_id', $category->id)->count() }}
                                                posts</span>
                                        </div>
                                    </div>
                                </li>
